...
/**
 * Created by Song on 2018/05/19.
 */
public class Hrml2ImgUtil2 extends JPanel {
     ...
     */
    public Hrml2ImgUtil2(final String file, final String url, final String WithResult) {
    ...
    public static boolean printUrlScreen2jpg(final String file,
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.getContentPane().add(new Hrml2ImgUtil2(file, url, withResult), BorderLayout.CENTER);
