...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-footer footer">
			<p>copyright @2018　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-small">捐赠作者</a></p>
		</div>
	</div>
	...
	<script type="text/javascript" src="${base}/static/js/leftNav.js"></script>
