...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="javascript:;" class="logo">个人博客管理</a>
            <!-- 显示/隐藏菜单 -->
        <#--<a href="javascript:;" class="seraph hideMenu icon-caidan"></a>-->
            <!-- 顶级菜单 -->
            <ul class="layui-nav mobileTopLevelMenus" mobile>
                <li class="layui-nav-item" data-menu="contentManagement">
                    <a href="javascript:;"><i class="seraph icon-caidan"></i><cite>宋文豪个人博客管理</cite></a>
            ...
            <#--</li>-->
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="favicon.ico" class="layui-nav-img userAvatar" width="35"
                                                height="35"><cite class="adminName">用户名</a>
                    <dl class="layui-nav-child">
    ...
    <#--&lt;#&ndash;<a class="img" title="我的头像" ><img src="images/face.jpg" class="userAvatar"></a>&ndash;&gt;-->
    <#--&lt;#&ndash;<p>你好！<span class="userName">用户名</span>, 欢迎登录</p>&ndash;&gt;-->
    <#--</div>-->
        <!-- 搜索 -->
...
<script type="text/javascript" src="${base}/static/js/layui/index.js"></script>
</html>